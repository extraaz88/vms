...
import 'package:vms/core/providers/target_provider.dart';
...
import 'package:vms/services/sales/assigned_leads_service.dart';
...
import 'package:vms/widgets/visit_details_form.dart';
    ...
    try {
      ...
      setState(() {
        ...
        if (preselectedLead != null) {
          ...
          // Auto-fill visiting place when lead is preselected
          // Priority: Address > Name (company removed)
          String visitingPlace = '';
          if (preselectedLead.address != null &&
              preselectedLead.address!.trim().isNotEmpty) {
            visitingPlace = preselectedLead.address!.trim();
          } else {
            visitingPlace = preselectedLead.name;
          }

          // Only auto-fill if place is not already set from preferences
          if (_visitPlace == null || _visitPlace!.isEmpty) {
            _visitPlace = visitingPlace;
          }

          // Auto-fill visiting person
          if (_visitPerson == null || _visitPerson!.isEmpty) {
            _visitPerson = preselectedLead.name;
          }

          debugPrint('✅ Auto-filled visiting place: $visitingPlace');
          debugPrint('✅ Auto-filled visiting person: ${preselectedLead.name}');
        }
      });
