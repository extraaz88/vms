...
class CheckinCheckoutDashboardCard extends StatefulWidget {
  const CheckinCheckoutDashboardCard({super.key});

  @override
  State<CheckinCheckoutDashboardCard> createState() => _CheckinCheckoutDashboardCardState();
}

class _CheckinCheckoutDashboardCardState extends State<CheckinCheckoutDashboardCard>
  ...
  void _handleCheckOut(Visit activeVisit) {
    _slideController.forward().then((_) {
      Future.delayed(const Duration(milliseconds: 200), () {
        if (mounted) {
  ...
  void _handleViewDetails(Visit activeVisit) {
    context.push('/visit/details/${activeVisit.id}');
  }
      ...
      builder: (context, visitProvider, child) {
        ...
        return Container(
          ...
          child: Column(
            children: [
              // Header
              _buildHeader(activeVisit, hasLocation),
              
              // Main Action Button
              _buildMainActionButton(activeVisit, hasLocation),
              
              // Location Info
              _buildLocationInfo(hasLocation),
              ...
              AnimatedBuilder(
                ...
                child: _buildSliderContent(activeVisit),
              ),
            ],
          ),
        );
  ...
  Widget _buildHeader(Visit? activeVisit, bool hasLocation) {
    return Container(
      padding: const EdgeInsets.all(20),
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: activeVisit != null
        ...
        children: [
          Container(
            ...
            child: Icon(
              ...
              color: activeVisit != null ? AppTheme.successColor : AppTheme.primaryColor,
              size: 24,
            ),
          ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  activeVisit != null ? 'Active Visit' : 'Check-in/Check-out',
                ...
                Text(
                  activeVisit != null 
                      ? 'Currently visiting ${activeVisit.clientName}'
                      : 'Start or manage your visits',
  ...
  Widget _buildMainActionButton(Visit? activeVisit, bool hasLocation) {
        ...
        return Transform.scale(
          ...
          child: Container(
            ...
            child: GestureDetector(
              onTap: hasLocation 
                  ? (isActive ? () => _handleCheckOut(activeVisit) : _handleCheckIn)
                  : null,
              child: Container(
  ...
  Widget _buildLocationInfo(bool hasLocation) {
    return Container(
  ...
  Widget _buildSliderContent(Visit? activeVisit) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (activeVisit != null) ...[
            _buildActiveVisitInfo(activeVisit),
          ] else ...[
            _buildCheckInInfo(),
          ],
            ...
            children: [
              Expanded(
                child: _buildActionButton(
                  ...
                  onTap: activeVisit != null 
                      ? () => _handleViewDetails(activeVisit)
                      : () => context.push('/visit/management'),
                ),
              ),
              const SizedBox(width: 12),
              Expanded(
  ...
  Widget _buildActiveVisitInfo(Visit visit) {
